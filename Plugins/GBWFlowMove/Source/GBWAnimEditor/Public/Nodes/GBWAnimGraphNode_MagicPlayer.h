...
#include "GBWAnimGraphNode_MagicPlayer.generated.h"

class FBlueprintActionDatabaseRegistrar;

UCLASS()
class GBWANIMEDITOR_API UGBWAnimGraphNode_MagicPlayer : public UAnimGraphNode_AssetPlayerBase
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(EditAnywhere, Category=Settings)
	FGBWAnimNode_MagicPlayer Node;
